...
#def generateImage(input_fn, input2_fn, output_fn):
#    image_1 = cv2.imread(input_fn)
#    image_2 = cv2.imread(input2_fn)
...
#    for test in ['rotation']:#['sample', 'scale', 'rotation', 'lighting']:
#        for num in range(2, 10):
#            prefix = 'images/test/%s/' % test
#            image_1 = prefix + 'image_1.jpg'
#            image_2 = prefix + '%s_%d.jpg' % (test, num)
#            output = 'images/output/%s/matches_output_%d.jpg' % (test, num)
#            generateImage(image_1, image_2, output)
