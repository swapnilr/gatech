...
SMPCache::SMPCache(SMemorySystem *dms, const char *section, const char *name)
    ...
    , compulsoryMiss("%s:compulsoryMiss", name)
{
...
void SMPCache::pStat() {
    ...
    printf("\t\tStat total=%8.0f:rdMiss=%8.0f:rdMissRate=%5.3f:wrMiss=%8.0f:wrMissRate=%5.3f:cmMiss=%8.0f:cmMissRate=%5.3f\n"
           ,total
           ,readMiss.getDouble()
           ,100*readMiss.getDouble()  / total
           ,writeMiss.getDouble()
           ,100*writeMiss.getDouble() / total
           ,compulsoryMiss.getDouble()
           ,100*compulsoryMiss.getDouble() / total
          );
