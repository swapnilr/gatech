...
public:
    ...
    static std::map<PAddr, int32_t> newBlockCnt;
    static std::map<PAddr, int32_t> ownBlockCnt;
    static std::map<PAddr, int32_t> getBlockCnt;
    static std::map<PAddr, int32_t> lastWriter;
