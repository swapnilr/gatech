...
public class InsignificantCAClusteringExperiments {
	...
	public static void main(String[] args) {
		...
		InsignificantComponentAnalysis pca = new InsignificantComponentAnalysis(set) ;
        pca.filter(set);
		...
		set = emreader.read();
		pca = new InsignificantComponentAnalysis(set) ;
	    pca.filter(set);
