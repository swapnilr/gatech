...
public class RandomizedClusteringExperiments {
	...
	public static void main(String[] args) {
		...
		RandomizedProjectionFilter ica = new RandomizedProjectionFilter(16, 16);
        ica.filter(set);
		...
		set = emreader.read();
		ica = new RandomizedProjectionFilter(40, 34);
        ica.filter(set);
