...
public class DimensionalityReductionClusteringTests {
	...
	public static void main(String[] args) {
        ...
        Matrix m = pca.getEigenValues();
        for(int i =0; i<m.m();i++) {
        	System.out.print(m.get(i,i) + ", ");
        }
        System.out.println();
        //pca.getEigenValues();
		...
		*/
		...
		set = emreader.read();
		pca = new PrincipalComponentAnalysis(set) ;
	    pca.filter(set);
	    System.out.println("WAVEFORM");
	    m = pca.getEigenValues();
	    for(int i =0; i<m.m();i++) {
        	System.out.print(m.get(i,i) + ", ");
        }
        System.out.println();
